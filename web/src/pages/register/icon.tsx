...
import { Box, Circle, Link, Image, Flex, Text } from "@chakra-ui/react";
        ...
        <Flex justify="center" p="15px">
            <Link>
              <button
                onClick={async () => {
                  await editProfile({
                    variables: { url: "https://pyxis.nymag.com/v1/imgs/8f8/e12/51b54d13d65d8ee3773ce32da03e1fa220-dogecoin.rsquare.w1200.jpg", id: userId },
                  });
                  router.push("/")
                }}
              >
